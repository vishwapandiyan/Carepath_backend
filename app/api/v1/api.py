...
from app.api.v1.endpoints import auth, patient, care_manager, ehr, chat, notifications, patient_response, care_plan, twilio_voice, voice_response
...
api_router.include_router(twilio_voice.router, prefix="/voice", tags=["Twilio Voice"])
api_router.include_router(voice_response.router, prefix="/voice", tags=["Voice - Response Processing"])
